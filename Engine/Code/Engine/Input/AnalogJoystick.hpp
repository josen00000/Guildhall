...
class AnalogJoystick {
	/*
	 *data and logic for joystick positioning & dead-zone corrections.
	 */
...
private:
	void UpdatePosition(short rawNormalizedX, short rawNormalizedY);
	void CorrectPosition(Vec2& rawPosition);
	void Reset();
private:
