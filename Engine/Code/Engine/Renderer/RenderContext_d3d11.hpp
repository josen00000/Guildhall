...
class RenderContext_d3d11 : public RenderContext{
public :
	RenderContext_d3d11();
...
public:
	...
	// Bind
	void virtual SetDiffuseTexture( Texture* texture, int index = 0 ) override;
	...
	void SetTintColor( const Rgba8& color ) override;
	...
	// raster state
	void virtual SetRasterCullMode( RasterCullMode mode ) override;
	...
	void virtual DrawIndexed( int indexCount, int indexOffset = 0, int vertexOffset = 0 ) override;
	void virtual DrawMesh( GPUMesh* mesh ) override;

	void virtual DrawVertexVector( const std::vector<Vertex_PCU>& vertices ) override;
	void virtual DrawIndexedVertexVector( const std::vector<Vertex_PCU>& vertices, const std::vector<uint>& indexes ) override;
	void virtual DrawVertexArray( int vertexNum, Vertex_PCU* vertexArray ) override;
	void virtual DrawLine( const Vec2& startPoint, const Vec2&endPoint, const float thick, const Rgba8& lineColor ) override;
	void virtual DrawAABB2D( const AABB2& bounds, const Rgba8& tint, const Vec2& uvMin = Vec2::ZERO, const Vec2& mvMax = Vec2::ONE ) override;
	void virtual DrawCircle( Vec3 center, float radius, float thick, const Rgba8& circleColor ) override;
	...
	void DrawPolygon2D( ConvexPoly2 polygon, Rgba8 tint );
	void DrawPolygon2DWithBound( ConvexPoly2 polygon, Rgba8 tint, float boundThick, Rgba8& boundColor );
