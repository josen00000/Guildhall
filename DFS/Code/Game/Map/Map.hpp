...
enum TileAttributeBitFlag: uint {
	TILE_NON_ATTR_BIT		= 0,
	TILE_IS_EDGE_BIT		= BIT_FLAG(0),
	TILE_IS_START_BIT		= BIT_FLAG(1),
	TILE_IS_EXIT_BIT		= BIT_FLAG(2),
	TILE_IS_ROOM_BIT		= BIT_FLAG(3),
	TILE_IS_SOLID_BIT		= BIT_FLAG(4),
	TILE_IS_REACHABLE_BIT	= BIT_FLAG(5),
	TILE_IS_VISITED_BIT		= BIT_FLAG(6),
};
...
public:
	...
	bool IsTileEdge( int tileIndex ) const;
	bool IsTileSolid( IntVec2 tileCoords ) const;
	bool IsTileSolid( int tileIndex ) const;
	bool IsTileReachable( IntVec2 tileCoords ) const;
	...
	void SetTileEdge( IntVec2 tileCoords, bool isEdge );
	void SetTileEdge( int tileIndex, bool isEdge );
	...
	void SetTileReachable( IntVec2 tileCoords, bool isReachable );
	void SetTileReachable( int tileIndex, bool isReachable );
...
private:
	...
	IntVec2							m_exitCoords = IntVec2::ZERO;
