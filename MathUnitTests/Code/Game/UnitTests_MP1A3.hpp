...
#define IntVec2_GetOrientationRadians		GetAngleRadians
#define IntVec2_GetOrientationDegrees		GetAngleDegrees
...
#define Function_RangeMapFloat				RangeMapFloat
#define Function_ClampFloat					temClampFloat
