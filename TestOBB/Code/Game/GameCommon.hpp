...
//Camera
constexpr float GAME_CAMERA_MIN_X	= -48.f;
constexpr float GAME_CAMERA_MIN_Y	= -27.f;
constexpr float GAME_CAMERA_MAX_X	= 48.f;
constexpr float GAME_CAMERA_MAX_Y	= 27.f;
